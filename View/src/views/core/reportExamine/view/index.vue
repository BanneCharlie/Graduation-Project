<template>
	<div>
		...
		<el-form ref="formItem" label-suffix=":" label-width="150px" label-position="right" size="medium">
			<el-card class="marginTopCard box-card" shadow="never">
				<div slot="header" class="clearfix item">
					<span>
						<i class="el-icon-s-order" style="margin-right: 20px"><b>检验报告审核表信息</b></i>
					</span>
				</div>
				<el-row>
					<el-col :span="12">
			...
			<el-card class="marginTopCard box-card" shadow="never">
				<div slot="header" class="clearfix item">
					<span>
						<i class="el-icon-s-order" style="margin-right: 20px"><b>审核信息</b></i>
					</span>
				</div>
				<el-row>
					<el-col :xl="24" :xs="24">
		...
		<!-- <el-button type="primary" @click="submitFormBeforeHandleAdviceIsFlush">test handler</el-button> -->
	</div>
</template>

<script>
import { getReportInstace, replaceReportContext } from '@/api/business/deviceTask';
