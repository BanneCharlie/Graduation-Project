<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="reqContReviewList" @selection-change="handleSelectionChange">
...
<script>
  import { listReqRepManage, delReqRepManage } from "@/api/business/reqRepManage";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listReqRepManage(this.addDateRange(this.queryParams, this.dateRange)).then(
          response => {
