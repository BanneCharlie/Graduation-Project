<template>
  <div>
    ...
    <el-form ref="formItem" :model="formItem" label-suffix=":" :rules="formRules" label-width="150px" label-position="right" size="medium">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item class="leftItem" label="委托单位" prop="entrustUnit">
              <el-input :disabled="judgeIsUpdate" class="uniflItem" v-model="formItem.entrustUnit"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="单位类型" prop="typeUnit">
              <el-select :disabled="judgeIsUpdate" class="uniflItem" v-model="formItem.typeUnit" placeholder="请选择">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item class="leftItem" label="使用单位" prop="useUnit">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model="formItem.useUnit"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="检验部门" prop="checkDept">
              <treeselect :disabled="judgeIsUpdate" class="uniflItem" style="text-align: center;" v-model="formItem.checkDept"
                :options="checkDept" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item class="leftItem" label="设备名称" prop="deviceName">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model="formItem.deviceName"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="检验类型" prop="checkCategory">
              <el-select :disabled="judgeIsUpdate" class="uniflItem" v-model="formItem.checkCategory" placeholder="请选择">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item class="leftItem" label="设备数量" prop="deviceCount">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model.number="formItem.deviceCount"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="合同金额" prop="contractMoney">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model="formItem.contractMoney"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <!-- -- -->
        <el-row>
          <el-col :span="12">
            <el-form-item class="leftItem" label="实收款" prop="realMoney">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model="formItem.realMoney"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="缴费类型" prop="paymentType">
              <el-select :disabled="judgeIsUpdate" class="uniflItem" v-model="formItem.paymentType" placeholder="请选择">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item class="leftItem" label="联系人" prop="liaisons">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model="formItem.liaisons"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="联系电话" prop="phone">
              <el-input :disabled="judgeIsUpdate" class="uniflItem" maxlength="11" show-word-limit v-model="formItem.phone"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <!-- -- -->
        <el-row>
          <el-col :span="12">
            <el-form-item class="leftItem" label="单位地址" prop="addressUnit">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model="formItem.addressUnit"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="邮编" prop="zipCode">
              <el-input :disabled="judgeIsUpdate" class="uniflItem " v-model="formItem.zipCode"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <!-- -- -->
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item class="leftItem" label="约检日期" prop="orderTime">
              <el-date-picker :disabled="judgeIsUpdate" class="uniflItem" v-model="formItem.orderTime" type="date"
                format="yyyy 年 MM 月 dd 日" :picker-options="pickerOptions">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="rightItem" label="编制日期" prop="formationTime">
              <el-date-picker :disabled="judgeIsUpdate" class="uniflItem" v-model="formItem.formationTime" type="date"
        ...
        <el-row>
          <el-col :span="24">
            ...
            <el-form-item class="leftItem" label="作业指导书" prop="fileResultIds">
              <treeselect class="uniflItem" style="text-align: 10px;width: 780px;text-align: left;" v-model="formItem.fileResultIdArr"
                searchable disableBranchNodes openDirection="top" :options="fileWorks" :show-count="true" :multiple="true"
                joinValues :disabled="judgeIsUpdate" placeholder="请选择作业指导书" />
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <DeviceList ref="deviceComponent" v-if="isEndStep" :deviceList="deviceList"></DeviceList>
        ...
        <el-row>
          <el-col :xl="24" :xs="24">
            <el-form-item class="textareaStyle" label="部门负责人审核">
              <el-input :disabled="reviewDisable.advice_bmfzrsh" class="intputTextarea" type="textarea" v-model="adviceMsg.advice_bmfzrsh"
                @dblclick.native="showDefaultOpinions('advice_bmfzrsh')"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xl="24" :xs="24">
            <el-form-item class="textareaStyle" label="业务部审核">
              <el-input :disabled="reviewDisable.advice_ywbsh" class="intputTextarea" type="textarea" v-model="adviceMsg.advice_ywbsh"
              @dblclick.native="showDefaultOpinions('advice_ywbsh')"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xl="24" :xs="24">
            <el-form-item class="textareaStyle" label="分管领导审核">
              <el-input :disabled="reviewDisable.advice_fgldsh" class="intputTextarea" type="textarea" v-model="adviceMsg.advice_fgldsh"
                @dblclick.native="showDefaultOpinions('advice_fgldsh')"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-card>
      ...
      initDeviceList() {
        ...
        getDicByType(this.formItem.deviceCategory).then(response => {
          ...
          for(var i = 0; i < this.formItem.deviceCount; i++) {
            deviceListTemp.push({
              orderNum: (i + 1),
              deviceNumber: this.formItem.contractNumber + '-' + dict.dictValue + '-' + (i + 1),
