...
test( '给图片添加超链接', function () {
    var editor = te.obj[0];
    var range = te.obj[1];
    editor.setContent( '<p><img  style="width: 200px;height: 200px" src="http://ueditor.baidu.com/img/favicon.ico">hello</p>' );
    range.selectNode( editor.body.firstChild.firstChild ).select();
    editor.execCommand( 'link', {href:'http://www.baidu.com/'} );
    var html = '<a  href="http://www.baidu.com/" ><img  src="http://ueditor.baidu.com/img/favicon.ico" _src=\"http://ueditor.baidu.com/img/favicon.ico" style="width: 200px;height: 200px" ></a>hello';
